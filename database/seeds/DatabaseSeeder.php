    ...
    public function run()
    {
        ...
        $user = [
            ...
            [
                ...
                'roles' => 'admin',
                'position' => 'lecturer',
                'email' => 'admin2@telkomuniversity.com',
                'phone_number' => '08123456766',
                'password' => 'password',
            ],
            [
                'id' => '3',
                ...
                'roles' => 'admin',
                'position' => 'rector',
                'email' => 'admin3@telkomuniversity.com',
            ...
            [
                'id' => '4',
                'name' => 'example-staff',
                'last_name' => 'example-staff',
                'roles' => 'user',
                'position' => 'staff',
                'email' => 'staff@telkomuniversity.com',
                'phone_number' => '08123456733',
                'password' => 'password',
            ],
            [
                'id' => '5',
