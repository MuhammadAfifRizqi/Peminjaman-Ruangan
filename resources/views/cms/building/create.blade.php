...
@section('main-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">{{ __('Create Building') }}</h1>
    ...
    <form method="POST" action="{{ route('building.create.process') }}" autocomplete="off" enctype="multipart/form-data">
        @csrf
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="pl-lg-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" class="form-control" name="name"
                                                value="{{ old('name') }}" placeholder="Example : TULT">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-6">
                                        <label class="form-control-label" for="exampleInputEmail1">Building Image<span
                                            class="small text-danger">*</span></label>
