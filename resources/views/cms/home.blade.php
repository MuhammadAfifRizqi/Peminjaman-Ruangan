            ...
            <div class="col-md-4 mb-4">
                <div class="card px-3" style="height: 100%;">
                    ...
                    <div class="mb-5 d-flex">
                        <img src="{{ asset('img/Gedung TULT.jpg') }}" style="object-fit: cover; border-radius: 10px;"
                            width="140px" height="150px" class="mr-3" alt="">
                        <div class="flex-fill justify-content-center flex-column d-flex">
                            <div>
                                <label> Progress Bar </label>
                                <br />
                                <div class="progress">
                                    <div class="progress-bar <strong>progress-bar-striped</strong> bg-primary"
                    ...
                    <div class="mb-5 d-flex">
                        <img src="{{ asset('img/dummy.jpg') }}" style="object-fit: cover; border-radius: 10px;"
                            width="140px" height="150px" class="mr-3" alt="">
                        <div class="flex-fill justify-content-center flex-column d-flex">
                            <div>
                                <label> Progress Bar </label>
